...
% colormap pink
% print_figure('figures/spectrogram_b.pdf',7,4,'RemoveMargin',true)
...
ylim([2 N-1])
colormap pink
% title('Zeros of the Spectrogram','Interpreter','latex')
% print_figure('figures/position_of_zeros.pdf',7,4,'RemoveMargin',true)